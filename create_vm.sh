...
#Set up forwarding rule, change priority
gcloud compute --project=$1 firewall-rules create firewall-rule --direction=INGRESS --priority=65534 --network=default --action=ALLOW --rules=tcp:7000 --source-ranges=0.0.0.0/0
